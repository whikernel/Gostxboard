...
* \version   1.0
* \date      May 21, 2015
* \brief     Functions for SHA256 computation
*
* \details   Functions for SHA256 computation. \n
...
* \version  1.0
* \date		21 Mai 2015
* \brief	Fonctions pour le calcul SHA256.
*
* \details	Fonctions pour le calcul SHA256. \n
*			\a NB : L'auteur du driver n'est pas l'auteur de ce fichier. Merci à "inconnu" pour cette implémentation.
*/
